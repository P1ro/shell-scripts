...
## INDEV: test_to_jupyter.py

## Converts txt or batspp based testfiles to Jupyter Notebook 
...
TEXT_FILE_PATH = "perl-script-modified.test"
CONVERTED_JUPYTER_PATH = gh.remove_extension(TEXT_FILE_PATH, ".test") + ".ipynb"
