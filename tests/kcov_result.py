...
COVERAGE_FOLDER = "coverage-reports"
REPORT_EXPORT_PATH = f"./{COVERAGE_FOLDER}/"
...
report_export_path_exists = gh.file_exists(COVERAGE_FOLDER)
...
"""     
        ...
        if self.EXPORT_OPT:
            ...
            if report_export_path_exists == False:
                gh.create_directory(COVERAGE_FOLDER)
